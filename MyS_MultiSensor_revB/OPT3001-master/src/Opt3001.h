...
#define DEFAULT_CONFIG_800    0b1100110000010011 // 800ms
#define DEFAULT_CONFIG_800_OS 0b1100101000010011 // 800ms, one shot

#define DEFAULT_CONFIG_100    0b1100010000010011 // 100ms
#define DEFAULT_CONFIG_100_OS 0b1100001000010011 // 100ms, one shot
...
class Opt3001
{
  public:
	...
	void	 init(); // init() used to trigger INT at end of each conversion
    void     shutDown();
    void     startConversion();
    void     startConversion(uint16_t startArg);
	void	 setLowLimit(uint16_t limit);
	void	 setHighLimit(uint16_t limit);
	float    readResult();
