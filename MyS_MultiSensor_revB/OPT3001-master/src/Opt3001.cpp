...
void Opt3001::init()
{
	writeRegister(LOWLIMIT_REG, 0b1100000000000000);
}
...
void Opt3001::setLowLimit(uint16_t limit)
{
	writeRegister(LOWLIMIT_REG, limit);
}

void Opt3001::setHighLimit(uint16_t limit)
{
	writeRegister(HIGHLIMIT_REG, limit);
}

uint16_t Opt3001::readRawResult()
{
	readConfigReg(); // To clear INT
